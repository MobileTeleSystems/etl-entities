...
from hwmlib.hwm.column_hwm import ColumnHWM
...
class DateTimeHWM(ColumnHWM[datetime]):
    ...
    Parameters
    ----------
    column : :obj:`hwmlib.source.db.column.Column`

        Column instance

    table : :obj:`hwmlib.source.db.table.Table`
    ...
    .. code:: python
        ...
        from datetime import datetime
        from hwmlib import DateTimeHWM, Column, Table
    ...
    def serialize(self) -> str:
        ...
        .. code:: python
            ...
            from datetime import datetime
            from hwmlib import DateTimeHWM
    ...
    def __eq__(self, other):
        ...
        Params
        -------
        other : :obj:`hwmlib.hwm.datetime_hwm.DateTimeHWM` or :obj:`datetime.datetime`
